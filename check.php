                        ...
                        <div class="row">
                                ...
                                <div class="toggle-content text-center" id="tab4">
                                    ...
                                    <font size="4" >
                                        ...
                                        <li><a href="psub.php">Paper Submission Deadline</a></li>
                                        <li><a href="rsub.php">Review Submission Deadline</a></li>
                                        <li><a href="rnotif.php">Review Notification Deadline</a></li>
                                      </font>
                                          <!--<input id="button" type="submit" name="searchs" value="Notify"><br>-->
                                        </form>
                                </div>
                            </div> <!-- /.col-md-12 -->
                        </div> <!-- /.row -->
