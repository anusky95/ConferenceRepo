    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="sidebar-menu">
                    ...
                    <div class="menu-wrapper">
                        <ul class="menu">
                            ...
                            <li><a class="show-1" href="#">View papers</a></li>
                            <li><a class="show-3" href="#">Review paper</a></li>
                            <li><a class="show-5" href="#">Deadlines</a></li>
                        </ul> <!-- /.menu -->
                                    ...
                                    <?php
                                      ...
                                      <?php while(($row = mysqli_fetch_array($data)) and ($row2 = mysqli_fetch_array($data2))) :?>
                                        <font size="4" color="black">
                                          <a href = 'reviewpaper.php?paper=<?php echo $row2[1]?>'> <?php echo $row2[1]; ?> </a>
                                       </font>
                                      <?php echo "<br>";?>
                                      <?php endwhile; ?>
                                </div>
            ...
            <div class="row">
                    ...
                    <div class="toggle-content text-center" id="tab4">
                        ...
                        <h4>Submit reviews</h4><br>
                            <?php
                                  ...
                                  <?php while(($row = mysqli_fetch_array($data)) and ($row2 = mysqli_fetch_array($data2))) :?>
                                  <font size="4" color="black">
                                  <a href = 'submitrate.php?paper=<?php echo $row2[1]?>'> <?php echo $row2[1]; ?> </a>
                                  </font>
                                  <?php echo "<br>";?>
                                  <?php endwhile; ?>
                    </div>
                ...
                <div id="menu-5" class="services content">
<div class="row">
        <div class="col-md-12 col-sm-12">
        <div class="toggle-content text-center" id="tab4">
